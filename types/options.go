...
// UnmarshalYAML decodes a mapping of string-to-scalar (null values become "").
...
// UnmarshalYAML decodes a mapping of string-to-(scalar|sequence) into a
// MultiOptions value. Scalars become a single-element slice.
