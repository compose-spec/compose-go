...
func deriveDeepCopyService(dst, src *ServiceConfig) {
	...
	if src.EnvFiles == nil {
		...
		deriveDeepCopy_16(dst.EnvFiles, src.EnvFiles)
	}
	if src.Expose == nil {
		dst.Expose = nil
	} else {
	...
	if src.ExtraHosts != nil {
		...
		deriveDeepCopy_17(dst.ExtraHosts, src.ExtraHosts)
	} else {
		dst.ExtraHosts = nil
	}
	if src.GroupAdd == nil {
	...
	if src.Gpus == nil {
		...
		deriveDeepCopy_18(dst.Gpus, src.Gpus)
	}
	...
	if src.HealthCheck == nil {
		...
		deriveDeepCopy_19(dst.HealthCheck, src.HealthCheck)
	}
	dst.Image = src.Image
	if src.Init == nil {
		dst.Init = nil
	...
	if src.Logging == nil {
		...
		deriveDeepCopy_20(dst.Logging, src.Logging)
	}
	...
	if src.Models != nil {
		...
		deriveDeepCopy_21(dst.Models, src.Models)
	} else {
		dst.Models = nil
	}
	dst.Net = src.Net
	...
	if src.Networks != nil {
		...
		deriveDeepCopy_22(dst.Networks, src.Networks)
	} else {
		dst.Networks = nil
	}
	...
	if src.Ports == nil {
		...
		deriveDeepCopy_23(dst.Ports, src.Ports)
	}
	...
	if src.Secrets == nil {
		...
		deriveDeepCopy_24(dst.Secrets, src.Secrets)
	}
	...
	if src.Ulimits != nil {
		...
		deriveDeepCopy_25(dst.Ulimits, src.Ulimits)
	} else {
		dst.Ulimits = nil
	}
	...
	if src.Volumes == nil {
		...
		deriveDeepCopy_26(dst.Volumes, src.Volumes)
	}
	...
	if src.PostStart == nil {
		...
		deriveDeepCopy_27(dst.PostStart, src.PostStart)
	}
	if src.PreStop == nil {
		dst.PreStop = nil
	} else {
		...
		deriveDeepCopy_27(dst.PreStop, src.PreStop)
	}
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
		src.Extensions.DeepCopy(dst.Extensions)
...
func deriveDeepCopy_7(dst, src *DevelopConfig) {
	if src.Watch == nil {
		...
		deriveDeepCopy_33(dst.Watch, src.Watch)
	}
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
		src.Extensions.DeepCopy(dst.Extensions)
...
func deriveDeepCopy_8(dst, src *BlkioConfig) {
	...
	if src.WeightDevice == nil {
		...
		deriveDeepCopy_34(dst.WeightDevice, src.WeightDevice)
	}
	if src.DeviceReadBps == nil {
		...
		deriveDeepCopy_35(dst.DeviceReadBps, src.DeviceReadBps)
	}
	if src.DeviceReadIOps == nil {
		...
		deriveDeepCopy_35(dst.DeviceReadIOps, src.DeviceReadIOps)
	}
	if src.DeviceWriteBps == nil {
		...
		deriveDeepCopy_35(dst.DeviceWriteBps, src.DeviceWriteBps)
	}
	if src.DeviceWriteIOps == nil {
		...
		deriveDeepCopy_35(dst.DeviceWriteIOps, src.DeviceWriteIOps)
	}
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
		src.Extensions.DeepCopy(dst.Extensions)
...
func deriveDeepCopy_12(dst, src *DeployConfig) {
	...
	if src.UpdateConfig == nil {
		...
		deriveDeepCopy_38(dst.UpdateConfig, src.UpdateConfig)
	}
	if src.RollbackConfig == nil {
		dst.RollbackConfig = nil
	} else {
		dst.RollbackConfig = new(UpdateConfig)
		deriveDeepCopy_38(dst.RollbackConfig, src.RollbackConfig)
	}
	func() {
		field := new(Resources)
		deriveDeepCopy_39(field, &src.Resources)
		dst.Resources = *field
	}()
	if src.RestartPolicy == nil {
		...
		deriveDeepCopy_40(dst.RestartPolicy, src.RestartPolicy)
	}
	func() {
		field := new(Placement)
		deriveDeepCopy_41(field, &src.Placement)
		dst.Placement = *field
	}()
...
func deriveDeepCopy_14(dst, src *ServiceProviderConfig) {
	...
	if src.Options != nil {
		...
		deriveDeepCopy_17(dst.Options, src.Options)
	} else {
		dst.Options = nil
	}
	if src.Extensions != nil {
...
func deriveDeepCopy_16(dst, src []EnvFile) {
	for src_i, src_value := range src {
		func() {
			field := new(EnvFile)
...
func deriveDeepCopy_18(dst, src []DeviceRequest) {
	for src_i, src_value := range src {
		func() {
...
func deriveDeepCopy_19(dst, src *HealthCheckConfig) {
	if src.Test == nil {
		dst.Test = nil
	} else {
		if dst.Test != nil {
...
func deriveDeepCopy_20(dst, src *LoggingConfig) {
...
func deriveDeepCopy_21(dst, src map[string]*ServiceModelConfig) {
	for src_key, src_value := range src {
		if src_value == nil {
			dst[src_key] = nil
		}
...
func deriveDeepCopy_22(dst, src map[string]*ServiceNetworkConfig) {
	for src_key, src_value := range src {
		if src_value == nil {
			dst[src_key] = nil
		}
...
func deriveDeepCopy_23(dst, src []ServicePortConfig) {
	for src_i, src_value := range src {
		func() {
...
func deriveDeepCopy_24(dst, src []ServiceSecretConfig) {
	for src_i, src_value := range src {
		func() {
...
func deriveDeepCopy_25(dst, src map[string]*UlimitsConfig) {
	for src_key, src_value := range src {
		if src_value == nil {
			dst[src_key] = nil
		}
...
func deriveDeepCopy_26(dst, src []ServiceVolumeConfig) {
	for src_i, src_value := range src {
		func() {
...
func deriveDeepCopy_28(dst, src *NetworkConfig) {
	dst.Name = src.Name
	dst.Driver = src.Driver
	...
	func() {
		...
		deriveDeepCopy_52(field, &src.Ipam)
		dst.Ipam = *field
	}()
...
func deriveDeepCopy_29(dst, src *VolumeConfig) {
	dst.Name = src.Name
	dst.Driver = src.Driver
	if src.DriverOpts != nil {
		dst.DriverOpts = make(map[string]string, len(src.DriverOpts))
...
func deriveDeepCopy_30(dst, src *SecretConfig) {
	dst.Name = src.Name
	dst.File = src.File
...
func deriveDeepCopy_31(dst, src *ConfigObjConfig) {
	dst.Name = src.Name
	dst.File = src.File
	dst.Environment = src.Environment
	dst.Content = src.Content
...
func deriveDeepCopy_32(dst, src *ModelConfig) {
	dst.Name = src.Name
	dst.Model = src.Model
...
func deriveDeepCopy_33(dst, src []Trigger) {
	for src_i, src_value := range src {
		func() {
			field := new(Trigger)
...
func deriveDeepCopy_34(dst, src []WeightDevice) {
	for src_i, src_value := range src {
		func() {
...
func deriveDeepCopy_35(dst, src []ThrottleDevice) {
	for src_i, src_value := range src {
		func() {
...
func deriveDeepCopy_36(dst, src *ServiceConfigObjConfig) {
...
func deriveDeepCopy_37(dst, src *ServiceDependency) {
...
func deriveDeepCopy_38(dst, src *UpdateConfig) {
...
func deriveDeepCopy_39(dst, src *Resources) {
	if src.Limits == nil {
		dst.Limits = nil
	} else {
		dst.Limits = new(Resource)
		deriveDeepCopy_56(dst.Limits, src.Limits)
	}
	if src.Reservations == nil {
		dst.Reservations = nil
	} else {
		dst.Reservations = new(Resource)
		deriveDeepCopy_56(dst.Reservations, src.Reservations)
	}
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
		src.Extensions.DeepCopy(dst.Extensions)
...
func deriveDeepCopy_40(dst, src *RestartPolicy) {
	dst.Condition = src.Condition
	if src.Delay == nil {
		dst.Delay = nil
	} else {
...
func deriveDeepCopy_41(dst, src *Placement) {
	...
	if src.Preferences == nil {
		...
		deriveDeepCopy_57(dst.Preferences, src.Preferences)
	}
...
func deriveDeepCopy_42(dst, src *DeviceMapping) {
	dst.Source = src.Source
	dst.Target = src.Target
...
func deriveDeepCopy_43(dst, src *EnvFile) {
	dst.Path = src.Path
	dst.Required = src.Required
	...
	if src.Context == nil {
		...
		dst.Context = new(NodeContext)
		deriveDeepCopy_58(dst.Context, src.Context)
	}
}

// deriveDeepCopy_44 recursively copies the contents of src into dst.
func deriveDeepCopy_44(dst, src *DeviceRequest) {
...
func deriveDeepCopy_45(dst, src *ServiceModelConfig) {
...
func deriveDeepCopy_46(dst, src *ServiceNetworkConfig) {
	if src.Aliases == nil {
		dst.Aliases = nil
	} else {
		if dst.Aliases != nil {
...
func deriveDeepCopy_47(dst, src *ServicePortConfig) {
	dst.Name = src.Name
	dst.Mode = src.Mode
...
func deriveDeepCopy_48(dst, src *ServiceSecretConfig) {
	dst.Source = src.Source
	dst.Target = src.Target
	dst.UID = src.UID
	dst.GID = src.GID
...
func deriveDeepCopy_49(dst, src *UlimitsConfig) {
...
func deriveDeepCopy_50(dst, src *ServiceVolumeConfig) {
	dst.Type = src.Type
	dst.Source = src.Source
	dst.Target = src.Target
	dst.ReadOnly = src.ReadOnly
	...
	if src.Bind == nil {
		...
		deriveDeepCopy_59(dst.Bind, src.Bind)
	}
	if src.Volume == nil {
		dst.Volume = nil
	} else {
		dst.Volume = new(ServiceVolumeVolume)
		deriveDeepCopy_60(dst.Volume, src.Volume)
	}
	if src.Tmpfs == nil {
		dst.Tmpfs = nil
	} else {
		dst.Tmpfs = new(ServiceVolumeTmpfs)
		deriveDeepCopy_61(dst.Tmpfs, src.Tmpfs)
	}
	if src.Image == nil {
		dst.Image = nil
	} else {
		dst.Image = new(ServiceVolumeImage)
		deriveDeepCopy_62(dst.Image, src.Image)
	}
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
		src.Extensions.DeepCopy(dst.Extensions)
...
func deriveDeepCopy_51(dst, src *ServiceHook) {
	if src.Command == nil {
		dst.Command = nil
	} else {
		if dst.Command != nil {
...
func deriveDeepCopy_52(dst, src *IPAMConfig) {
	dst.Driver = src.Driver
	if src.Config == nil {
		dst.Config = nil
	} else {
		...
		deriveDeepCopy_63(dst.Config, src.Config)
	}
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
		src.Extensions.DeepCopy(dst.Extensions)
...
func deriveDeepCopy_53(dst, src *Trigger) {
	dst.Path = src.Path
	dst.Action = src.Action
	dst.Target = src.Target
	func() {
		field := new(ServiceHook)
		deriveDeepCopy_51(field, &src.Exec)
		dst.Exec = *field
	}()
	if src.Include == nil {
		dst.Include = nil
...
func deriveDeepCopy_54(dst, src *WeightDevice) {
	dst.Path = src.Path
	dst.Weight = src.Weight
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
...
func deriveDeepCopy_55(dst, src *ThrottleDevice) {
	dst.Path = src.Path
	dst.Rate = src.Rate
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
...
func deriveDeepCopy_56(dst, src *Resource) {
	...
	if src.Devices == nil {
		...
		deriveDeepCopy_18(dst.Devices, src.Devices)
	}
	if src.GenericResources == nil {
		...
		deriveDeepCopy_64(dst.GenericResources, src.GenericResources)
	}
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
		src.Extensions.DeepCopy(dst.Extensions)
...
func deriveDeepCopy_58(dst, src *NodeContext) {
	dst.Source = src.Source
	dst.WorkingDir = src.WorkingDir
	if src.Env != nil {
		dst.Env = make(map[string]string, len(src.Env))
		deriveDeepCopy_5(dst.Env, src.Env)
	} else {
		dst.Env = nil
	}
	if src.Parent == nil {
		...
		dst.Parent = new(NodeContext)
		deriveDeepCopy_58(dst.Parent, src.Parent)
	}
}

// deriveDeepCopy_59 recursively copies the contents of src into dst.
func deriveDeepCopy_59(dst, src *ServiceVolumeBind) {
...
func deriveDeepCopy_60(dst, src *ServiceVolumeVolume) {
	if src.Labels != nil {
		dst.Labels = make(map[string]string, len(src.Labels))
		deriveDeepCopy_5(dst.Labels, src.Labels)
	} else {
...
func deriveDeepCopy_61(dst, src *ServiceVolumeTmpfs) {
	dst.Size = src.Size
	dst.Mode = src.Mode
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
...
func deriveDeepCopy_62(dst, src *ServiceVolumeImage) {
	dst.SubPath = src.SubPath
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
		src.Extensions.DeepCopy(dst.Extensions)
...
func deriveDeepCopy_63(dst, src []*IPAMPool) {
	for src_i, src_value := range src {
		if src_value == nil {
			...
			deriveDeepCopy_66(dst[src_i], src_value)
		}
	}
}
...
func deriveDeepCopy_64(dst, src []GenericResource) {
	for src_i, src_value := range src {
		func() {
			...
			deriveDeepCopy_67(field, &src_value)
			dst[src_i] = *field
		}()
	}
}
...
func deriveDeepCopy_65(dst, src *PlacementPreferences) {
...
func deriveDeepCopy_66(dst, src *IPAMPool) {
...
func deriveDeepCopy_67(dst, src *GenericResource) {
	if src.DiscreteResourceSpec == nil {
		dst.DiscreteResourceSpec = nil
	} else {
		dst.DiscreteResourceSpec = new(DiscreteGenericResource)
		deriveDeepCopy_68(dst.DiscreteResourceSpec, src.DiscreteResourceSpec)
	}
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
		src.Extensions.DeepCopy(dst.Extensions)
...
func deriveDeepCopy_68(dst, src *DiscreteGenericResource) {
	dst.Kind = src.Kind
	dst.Value = src.Value
	if src.Extensions != nil {
		dst.Extensions = make(map[string]any, len(src.Extensions))
